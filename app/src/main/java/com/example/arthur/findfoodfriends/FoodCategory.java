...
public class FoodCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodCategory = (Button) findViewById(R.id.foodCategory);
        genderAge = (Button) findViewById(R.id.genderAge);
        ...
        foodCategory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(FoodCategory.this, ChoosingCategory.class);
